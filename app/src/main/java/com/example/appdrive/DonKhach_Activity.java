...
public class DonKhach_Activity extends FragmentActivity implements OnMapReadyCallback, TaskLoadedCallback {
    private static final int ERROR_DIALOG_REQUEST = 9001;
    private static final int REQUEST_CALL = 1;
    String phoneNumber;
    Button btnXacNhanDonKhach, call,sms;
    private GoogleMap mMap;
    private Polyline currentPolyline;
    private MarkerOptions place2;
    private TextView cuaHang,tongTien,diaChi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(isServicesOK()){
            ...
            cuaHang = findViewById(R.id.TextCuaHang);
            diaChi = findViewById(R.id.TextDiaChi);
    ...
    {
        if(ContextCompat.checkSelfPermission(DonKhach_Activity.this,
                Manifest.permission.CALL_PHONE)!=PackageManager.PERMISSION_GRANTED){
            ActivityCompat.requestPermissions(DonKhach_Activity.this,
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    for(int i = 0 ; i < jsonArray.length();i++)
                    {
                        ...
                        String shopAddress = shipIF.getString("shop address");
                        String shopName = shipIF.getString("shop name");
                        Double shopLat = shipIF.getDouble("lat shop");
                        Double shopLng = shipIF.getDouble("lng shop");
                        phoneNumber = shipIF.getString("number user");

                        cuaHang.setText(shopName);
                        diaChi.setText(shopAddress);
                        place2 = new MarkerOptions().position(new LatLng(shopLat, shopLng)).title(shopName);
                        new FetchURL(DonKhach_Activity.this).execute(getUrl(userLocation, place2.getPosition(), "transit"), "transit");
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
    ...
    public boolean isServicesOK(){
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(DonKhach_Activity.this);
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(DonKhach_Activity.this, available, ERROR_DIALOG_REQUEST);
            dialog.show();
        }else{
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()){
                           ...
                           // new FetchURL(DonKhach_Activity.this).execute(getUrl(new LatLng(currentLocation.getLatitude(), currentLocation.getLongitude()), place2.getPosition(), "transit"), "transit");
                            ...
                            Toast.makeText(DonKhach_Activity.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private void initMap(){
        ...
        mapFragment.getMapAsync(DonKhach_Activity.this);
    }
